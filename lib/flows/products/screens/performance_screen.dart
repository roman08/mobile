...
class _PerformanceStyle {
  ...
  factory _PerformanceStyle.fromOldTheme(AppThemeOld theme) {
...
class _PerformanceScreenState extends State<PerformanceScreen> {
  ...
  final _PerformanceStyle _style = _PerformanceStyle.fromOldTheme(AppThemeOld.defaultTheme());
  String _chosenValue;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<InvestmentAccountsCubit, InvestmentAccountsState>(
      ...
      listener: (context, state) {
        ...
        if (state?.acountPerformance == true) {
        ...
        body: ListView(
          children: [
            ...
            Padding(
              ...
              child: Button(
                title: 'Continue',
                onPressed:  () {widget.onRequest(context, 3, _chosenValue);},
              ),
            ),
          ],
        ),
  ...
  Widget _appBar(BuildContext context) {   return
    AppBar(
        ...
        children: [
          ...
          Container(
            child: Padding(
              ...
              child: Text('Inversión Performance+',
      ...
      backgroundColor:  Color(0xFFD1AC00),
      actions:null,
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(child: Image.asset(IconsPNG.currencyPerformance))
          ],
        ),
      );
  }
              ...
              children: [
                TableRow(
                  children: [
                    ...
                    Text('Disponibilidad anual', style: TextStyle(color: Colors.black, fontSize: 20.0)),
                  ]
                )
              ],
            ),
                ...
                children: [
                  TableRow(
                    children: [
                      ...
                      Text('Estimado entre 8% y 12% en base anual', style: TextStyle(color: Colors.black, fontSize: 20.0)),
                    ]
                  )
                ],
              ),
