...
class DocumentLoader extends StatefulWidget {
  final String title;
  ...
  @override
  _DocumentLoaderState createState() => _DocumentLoaderState();
}

class _DocumentLoaderState extends State<DocumentLoader> {
  String filePath;
