...
import '../widget/add_funds_phone_number_form.dart';

class _AddFundsPhoneNumberScreenStyle {
  final TextStyle titleTextStyle;
  final TextStyle defaultTextStyle;
  final TextStyle boldTextStyle;
  final AppColorsOld colors;

  _AddFundsPhoneNumberScreenStyle({
    this.titleTextStyle,
  ...
  factory _AddFundsPhoneNumberScreenStyle.fromOldTheme(AppThemeOld theme) {
    return _AddFundsPhoneNumberScreenStyle(
      titleTextStyle:
...
class AddFundsPhoneNumberScreen extends StatelessWidget {
  AddFundsPhoneNumberScreen({this.title, this.currency});

  final _AddFundsPhoneNumberScreenStyle _style =
      _AddFundsPhoneNumberScreenStyle.fromOldTheme(AppThemeOld.defaultTheme());
